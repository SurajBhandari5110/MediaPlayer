...
def play_next():
    ...
    next_song=next_song[0]+1 #get index of next song
...
listBox=tk.Listbox(canvas,fg='white',bg='black',width=120, font=('Comic Sans MS',15))
listBox.pack(padx=15, pady=15)

label=tk.Label(canvas,text='', bg='black',fg='green',font=('poppins',19))
label.pack(pady=15)
